...
namespace EmployeeManagement.Data.Migrations
{
    ...
    [Migration("20210414060649_AbsenceRemovedColumn")]
    partial class AbsenceRemovedColumn
    {
            ...
            modelBuilder.Entity("EmployeeManagement.Models.Absence", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AbsenceTypeId = 2,
                            Date = new DateTime(2021, 4, 11, 2, 6, 49, 218, DateTimeKind.Local).AddTicks(6301),
                            EmployeeId = "1"
                        },
                        new
                        {
                            Id = 2L,
                            AbsenceTypeId = 4,
                            Date = new DateTime(2021, 4, 14, 2, 6, 49, 221, DateTimeKind.Local).AddTicks(440),
                            EmployeeId = "2"
                        });
                });
            ...
            modelBuilder.Entity("EmployeeManagement.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "526a2d7d-57bb-41a6-bec2-de73ad0ff7cf",
                            DepartmentId = 2,
                            ...
                            SecurityStamp = "2aa9ba10-989e-47be-8171-e04c6b52bba1",
                        ...
                        new
                        {
                            Id = "2",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4e4a424c-6f0f-4738-8f03-d9e0972b677b",
                            DepartmentId = 2,
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "810b94a2-9002-48e9-8e9d-2e249e437a51",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("EmployeeManagement.Models.Grievance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateAnswered = new DateTime(2021, 4, 8, 2, 6, 49, 221, DateTimeKind.Local).AddTicks(1814),
                            DateSubmitted = new DateTime(2021, 4, 7, 2, 6, 49, 221, DateTimeKind.Local).AddTicks(1585),
                            EmployeeId = "2",
                            RespondantId = "1"
                        },
                        new
                        {
                            Id = 2,
                            Body = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                            DateAnswered = new DateTime(2021, 4, 11, 2, 6, 49, 221, DateTimeKind.Local).AddTicks(2362),
                            DateSubmitted = new DateTime(2021, 4, 10, 2, 6, 49, 221, DateTimeKind.Local).AddTicks(2352),
                            EmployeeId = "2",
                            RespondantId = "1"
                        });
                });
