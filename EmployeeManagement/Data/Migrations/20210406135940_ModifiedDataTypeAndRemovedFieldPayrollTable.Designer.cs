...
namespace EmployeeManagement.Data.Migrations
{
    ...
    [Migration("20210406135940_ModifiedDataTypeAndRemovedFieldPayrollTable")]
    partial class ModifiedDataTypeAndRemovedFieldPayrollTable
    {
            ...
            modelBuilder.Entity("EmployeeManagement.Models.Absence", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AbsenceTypeId = 2,
                            EmployeeId = "1",
                            EndTime = new DateTime(2021, 4, 6, 9, 59, 40, 167, DateTimeKind.Local).AddTicks(8486),
                            StartTime = new DateTime(2021, 4, 3, 9, 59, 40, 165, DateTimeKind.Local).AddTicks(5427)
                        },
                        new
                        {
                            Id = 2L,
                            AbsenceTypeId = 4,
                            EmployeeId = "2",
                            EndTime = new DateTime(2021, 4, 6, 9, 59, 40, 167, DateTimeKind.Local).AddTicks(9443),
                            StartTime = new DateTime(2021, 4, 3, 9, 59, 40, 167, DateTimeKind.Local).AddTicks(9430)
                        });
                });
            ...
            modelBuilder.Entity("EmployeeManagement.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5b736860-81b6-4f09-bf2b-bc1da8427fe8",
                            DepartmentId = 2,
                            ...
                            SecurityStamp = "e14d25d4-1b2f-4791-8c92-6a6313187a24",
                        ...
                        new
                        {
                            Id = "2",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c7c154aa-af00-4d49-a155-b0a6999fd7ac",
                            DepartmentId = 2,
                            ...
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "715ee4b7-a6a1-4326-8670-ba797e29cb3e",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("EmployeeManagement.Models.Grievance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateAnswered = new DateTime(2021, 3, 31, 9, 59, 40, 168, DateTimeKind.Local).AddTicks(1736),
                            DateSubmitted = new DateTime(2021, 3, 30, 9, 59, 40, 168, DateTimeKind.Local).AddTicks(1309),
                            EmployeeId = "2",
                            RespondantId = "1"
                        },
                        new
                        {
                            Id = 2,
                            Body = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                            DateAnswered = new DateTime(2021, 4, 3, 9, 59, 40, 168, DateTimeKind.Local).AddTicks(2963),
                            DateSubmitted = new DateTime(2021, 4, 2, 9, 59, 40, 168, DateTimeKind.Local).AddTicks(2954),
                            EmployeeId = "2",
                            RespondantId = "1"
                        });
                });
